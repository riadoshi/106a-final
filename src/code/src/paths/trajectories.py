...
class LinearTrajectory(Trajectory):
    ...
    def target_velocity(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            time = time - self.total_time/2
            linear_vel = self.v_max - self.acceleration*time
...
class CircularTrajectory(Trajectory):
    ...
    def target_pose(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            # TODO: Calculate the ANGLE of the end effector at time t, 
            # For the second half of the trajectory, maintain a constant acceleration
            # Hint: Calculate thefeed-forward (or open loop) joint velocity controller remaining angle to the goal position. 
    ...
    def target_velocity(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            theta = (0.5*self.angular_acceleration*(time**2))
            theta_dot = self.angular_acceleration*theta
        else:
            ...
            theta = np.pi + ((self.angular_v_max * time) - (0.5*self.angular_acceleration*(time**2)))
            theta_dot = self.angular_v_max - self.angular_acceleration*theta
